class AppPaths {
  ...
  static const home = AppPath(path: '/');
  static const buttons = AppPath(path: '/buttons');
  static const components = AppPath(path: '/components');
  static const icons = AppPath(path: '/icons');
  static const popUp = AppPath(path: '/pop_up');
  static const illustration = AppPath(path: '/illustration');
  static const spaceShadow = AppPath(path: '/space_shadow');
  static const input = AppPath(path: '/input');
  static const swatches = AppPath(path: '/swatches');
  static const textStyle = AppPath(path: '/text_style');
